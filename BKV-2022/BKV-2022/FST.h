...
#define STRING_LITERAL(string) string, 3,	\
	...
	FST::NODE(159,	FST::RELATION(' ', 1),	\
					...
					FST::RELATION('8', 1), FST::RELATION('9', 1),	FST::RELATION('à', 1), FST::RELATION('á', 1),	\
					...
					FST::RELATION('Ð', 1), FST::RELATION('Ñ', 1),   FST::RELATION('Ó', 1), FST::RELATION('Ì', 1),	FST::RELATION('Ò', 1), FST::RELATION('Ó', 1),	\
...
#define CHAR_LITERAL(string) string, 3,	\
	...
	FST::NODE(158,	FST::RELATION(' ', 1),	\
					...
					FST::RELATION('È', 1), FST::RELATION('É', 1),	FST::RELATION('Ê', 1), FST::RELATION('Ë', 1),	\
					FST::RELATION('Ì', 1), FST::RELATION('Í', 1),	FST::RELATION('Î', 1), FST::RELATION('Ï', 1),	\
					FST::RELATION('Ð', 1), FST::RELATION('Ñ', 1),   FST::RELATION('Ó', 1), FST::RELATION('Ì', 1),	FST::RELATION('Ò', 1), 	\
					FST::RELATION('Ô', 1), FST::RELATION('Õ', 1),	FST::RELATION('Ö', 1), FST::RELATION('×', 1),	\
					FST::RELATION('Ø', 1), FST::RELATION('Ù', 1),	FST::RELATION('Ü', 1), FST::RELATION('Ú', 1),	\
					FST::RELATION('Û', 1), FST::RELATION('Ý', 1),	FST::RELATION('Þ', 1), FST::RELATION('ß', 1),	\
					FST::RELATION('=', 1), FST::RELATION('+', 1),	FST::RELATION('-', 1), FST::RELATION('*', 1),	\
					FST::RELATION('/', 1), FST::RELATION('(', 1),	FST::RELATION(')', 1), FST::RELATION('{', 1),	\
					FST::RELATION('}', 1), FST::RELATION(';', 1),	FST::RELATION(',', 1), FST::RELATION('?', 1),	\
					FST::RELATION(':', 1), FST::RELATION('@', 1),	FST::RELATION('|', 1), FST::RELATION('Ó', 1),	\
					FST::RELATION('!', 1),FST::RELATION('>', 1),	FST::RELATION('<', 1), FST::RELATION('\\', 1), \
					FST::RELATION('.', 1),FST::RELATION('#', 1),	FST::RELATION('¹', 1), FST::RELATION('&', 1), \
					FST::RELATION('[', 1),FST::RELATION(']', 1),FST::RELATION('_', 1), \
FST::RELATION('\'', 2)),\
